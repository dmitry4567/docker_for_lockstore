...
class CartDialogDesktop extends StatefulWidget {
  const CartDialogDesktop(this.keyScaffold, {super.key});

  final GlobalKey<ScaffoldState> keyScaffold;

  @override
  State<CartDialogDesktop> createState() => CartDialogState();
}

class CartDialogState extends State<CartDialogDesktop> {
